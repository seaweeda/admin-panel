    ...
    <div className="pt-4 bg-white top-0 sticky">
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="text-4xl font-bold">Seaweeda</div>
          <div className="lg:flex hidden w-full max-w-[500px]">
            <input
              className="border-2 border-[#800000] px-6 py-2 w-full"
              type="text"
              placeholder="Search for products here"
            />

            <div className="bg-[#800000] text-white text-[26px] grid place-items-center px-4">
              <BsSearch />
            </div>
          </div>
